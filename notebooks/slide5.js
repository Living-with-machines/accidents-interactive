...
function _decadeSelected(decadeSelector,categoryDataByDecade){return(
...
function _getChart(d3,svg,categoryDataByDecade){return(
({
    decade = 1830,
    width = 600,
    height = 400,
...
function _decadeSelector(html){return(
